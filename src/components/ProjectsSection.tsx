  ...
  const projects = [
    {
      ...
      link2: 'https://github.com/nambirevathi/Neural-Machine-Translation'
    },
    {
      ...
      link2: 'https://wedding-website-blond.vercel.app/'
    },
    {
      title: 'AI Code Generator (Code Copilot)',
      ...
      image: 'https://images.unsplash.com/photo-1555949963-aa79dcee981c?w=500&h=300&fit=crop',
      link: 'https://github.com/nambirevathi/Code-Copilot',
      link2: 'https://code-copilot-theta.vercel.app/'
    },
     {
      ...
      link: 'https://github.com/nambirevathi/food-receipe-gen-ai',
      link2: 'https://food-receipe-gen-ai.vercel.app/'
    },
    {
      title: 'Delevery App Mern',
      description: 'A comprehensive healthcare management system built with MERN stack featuring appointment scheduling, patient management, doctor profiles, and medical records.',
      tech: ['MongoDB', 'Express.js', 'React', 'Node.js'],
      color: 'from-emerald-400 to-green-500',
      image: 'https://images.unsplash.com/photo-1559757148-5c350d0d3c56?w=500&h=300&fit=crop',
      link: 'https://github.com/nambirevathi/DeliveryApp_Mern'
    },
    {
                ...
                <div className="p-6">
                  ...
                  {project.link ? (
                    ...
                    <a 
                      ...
                      target="_blank" 
                      rel="noopener noreferrer"
                      className="inline-flex items-center bg-[#ffffff] m-5 hover:bg-[hsl(var(--button-bg))]/90 text-[hsl(var(--button-text))] px-4 py-2 rounded-full font-medium transition-all duration-300 transform hover:scale-105"
                    >
                      Live Demo <ExternalLink size={16} className="ml-2" />
                    </a>
                  ) : (
                    <button className="inline-flex items-center m-5 bg-[#ffffff] hover:bg-[hsl(var(--button-bg))]/90 text-[hsl(var(--button-text))] px-4 py-2 rounded-full font-medium transition-all duration-300 transform hover:scale-105">
                      Live Demo <ExternalLink size={16} className="ml-2" />
                    </button>
                  )}
                </div>
